...
dayOfTheWeek = todaysDate.getDay();
...
function output(templeList) {
  templeList.forEach((temple) => {
    ...
    imageUrl.setAttribute("alt", templeName);
...
function sortBy() {
  ...
  if (sorted === "templeNameAscending") {
    output(
      templeList.sort((templeA, templeB) => {
        let templeNameA = templeA.templeName.toLowerCase();
        let templeNameB = templeB.templeName.toLowerCase();
        if (templeNameA < templeNameB) return -1;
        else if (templeNameA > templeNameB) return 1;
        else return 0;
      })
    );
  } else if (sorted === "templeNameDescending") {
    output(
      templeList.sort((templeA, templeB) => {
        let templeNameA = templeA.templeName.toLowerCase();
        let templeNameB = templeB.templeName.toLowerCase();
